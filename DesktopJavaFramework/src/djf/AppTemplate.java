...
public abstract class AppTemplate extends Application {
	...
	try {
            ...
            ChoiceDialog<String> dialog = new ChoiceDialog<>("Select language", choices);
            dialog.setTitle("Language Selecter");
...
// Traditional way to get the response value.
            ...
            else if(result.get().equals("Urdu")){
              success = loadProperties(APP_PROPERTIES_FILE_NAME_URDU);  
            }
            else{
                 AppMessageDialogSingleton dialog2 = AppMessageDialogSingleton.getSingleton();
                 dialog2.setMinWidth(400);
                 dialog2.show("Language Error", "Language not selected");
