...
public class AppGUI {
    ...
    protected BorderPane appPane, topPane;

    // THIS IS THE TOP TOOLBAR AND ITS CONTROLS
    protected FlowPane fileToolbarPane, rightFiletoolbarPane;
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        exportButton.setOnAction(e -> {
            try {
                ...
                fileController.handleExportRequest(s,c);
        ...
        aboutButton.setOnAction(e -> {
            fileController.handleAboutButton();
        });
    }
    ...
    private void initWindow() {
        ...
        topPane.setCenter(fileToolbarPane);
    ...
    public static void setString(String s1){
        s = s1;
    }
    
     public static void setString2(String s2){
        c = s2;
    }
