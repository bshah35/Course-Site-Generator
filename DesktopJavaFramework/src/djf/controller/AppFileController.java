...
import static djf.settings.AppPropertyType.ABOUT_CSG_TITLE;
...
public class AppFileController {
    ...
    File currentWorkFile, TeamStudentFile;
    ...
    private void saveWork(File selectedFile) throws IOException {
        ...
        // SAVE IT TO A FILE
        //1 = Syllabus export
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/OfficeHoursGridData.json", 1);
        //2 = Recitation Export
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/RecitationsData.json", 2);
        //3 = Schedule Export
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/ScheduleData.json", 3);
        //4 = ProjectsData Export
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/TeamsAndStudents.json", 4);

        //5 = ProjectsData Export
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/ProjectsData.json", 5);
        
        app.getFileComponent().saveData(app.getDataComponent(), "../TAManager/ExportFiles/CourseData.json", 6);

        app.getFileComponent().saveData(app.getDataComponent(), selectedFile.getPath(), 0);
        // MARK IT AS SAVED
    ...
    public void handleExportRequest(String s,String c) throws IOException {
        // WE'LL NEED THIS TO GET CUSTOM STUFF
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        ...
        try {
            if (currentWorkFile != null) {
                ...
                File choose = new File(s + "/public_html");
             
                copy(choose, selectedFile);
               
                File newDest = new File(selectedFile.getAbsolutePath() + "/js/OfficeHoursGridData.json");
                File newDest2 = new File(selectedFile.getAbsolutePath() + "/js/RecitationsData.json");
                File newDest3 = new File(selectedFile.getAbsolutePath() + "/js/TeamsAndStudents.json");
                File newDest4 = new File(selectedFile.getAbsolutePath() + "/js/ProjectsData.json");
                TeamStudentFile = new File("../TAManager/ExportFiles/OfficeHoursGridData.json");
                copyFile(TeamStudentFile, newDest);
                TeamStudentFile = new File("../TAManager/ExportFiles/RecitationsData.json");
                copyFile(TeamStudentFile, newDest2);
                TeamStudentFile = new File("../TAManager/ExportFiles/TeamsAndStudents.json");
                copyFile(TeamStudentFile, newDest3);
                TeamStudentFile = new File("../TAManager/ExportFiles/ProjectsData.json");
                copyFile(TeamStudentFile, newDest4);
    ...
    public void handleUndo() {
        app.getWorkspaceComponent().UndoButton();
    }

    public void handleRedo() {
        app.getWorkspaceComponent().redoButton();
    }
    ...
    public void handleAboutButton() {
        ...
        String text = props.getProperty(ABOUT_CSG_MESSAGE);
        ...
        dialog.show(props.getProperty(ABOUT_CSG_TITLE), sb.toString());
    }
