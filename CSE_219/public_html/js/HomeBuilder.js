...
function addImage(data) {
    var image = $("#image1");
    var text = "";
    text += buildImageData(data.image1);
...
function buildImageData(image) {

    var img = image.image1;

    var text = "<a href=http://www.stonybrook.edu><img alt=Stony Brook University class=sbu_navbar src="+img+"></a>";
